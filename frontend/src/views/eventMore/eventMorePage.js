        ...
        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
          <div class="p-6 flex flex-col">
            ...
            <div class="w-full flex justify-between max-sm:flex-col">
              <a class="allocate-resources flex items-center m-2 ml-0 font-medium text-lg/tight cursor-pointer text-black-900 underline-offset-4 hover:underline gap-2">
                Allocate resource.
                <lord-icon class="size-6" src="https://cdn.lordicon.com/iawrhwdo.json" trigger="hover" state="morph-coins"></lord-icon>
              </a>
              ${eventResources.length > 0 ? `
                <a class="check-resources flex items-center m-2 ml-0 font-medium text-lg/tight cursor-pointer text-black-900 underline-offset-4 hover:underline gap-2">
                  Check resources.
