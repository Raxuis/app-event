...
<div class="h-full flex flex-col items-center justify-center pt-6 sm:pt-20 px-4">
          <div class="border border-gray-300 rounded-md p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form class="space-y-6 edit-form">
              <div class="mb-10">
              ...
              <div class="flex flex-col space-y-2">
                ...
                <input type="text" name="email" id="email" class="w-full text-sm border border-gray-300 px-4 py-3 rounded-md outline-[#333]" placeholder="Enter email" value=${userInfos.email} />
              </div>
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  <input name="new-account-password" type="password" required class="w-full text-sm border border-gray-300 px-4 py-3 rounded-md outline-[#333]" placeholder="Enter password" id="new-account-password" />
              ...
              <div class="relative flex items-center">
                <input name="new-password-account-confirmation" type="password" required class="w-full text-sm border border-gray-300 px-4 py-3 rounded-md outline-[#333]" placeholder="Enter confirmation password" id="new-password-account-confirmation"/>
              ...
              <div class="!mt-10">
              <button type="button" class="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-white bg-primary hover:opacity-90 focus:outline-none">
              Edit
            </button>
