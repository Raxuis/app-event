  ...
  return `
    <div tabindex="0" class="*:cursor-default focus:outline-none mx-2 w-full sm:w-80 lg:w-72 xl:w-80 mb-8 flex flex-col shadow-md relative card-${eventId}">
      <div class="relative w-full h-44">
        ...
        <button class="export-csv-${eventId} cursor-pointer absolute left-1 bottom-1 inline-flex items-center p-2 text-white bg-blue-chill-700 hover:bg-jade-600 duration-300 text-sm font-medium rounded-md">
