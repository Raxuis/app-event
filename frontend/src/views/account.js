          ...
          <div class="border border-gray-300 rounded-md p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form class="space-y-6 account-form">
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  <input name="password" type="password" required class="w-full text-sm border border-gray-300 px-4 py-3 rounded-md outline-[#333]" placeholder="Enter password" id="new-account-password" />
              ...
              <div class="relative flex items-center">
                <input name="password-confirmation" type="password" required class="w-full text-sm border border-gray-300 px-4 py-3 rounded-md outline-[#333]" placeholder="Enter confirmation password" id="new-password-account-confirmation"/>
