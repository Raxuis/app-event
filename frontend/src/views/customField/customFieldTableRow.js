  ...
  if (customFields.length < 2) {
    return `${customFields.map((custom_field) => `
      <td class="pt-4 text-center">
        ...
        <span class="text-center align-baseline inline-flex py-1.5 px-6 rounded-lg items-center font-semibold text-[.95rem] leading-none bg-cerise-red-100 text-cerise-red-600 cursor-default">
