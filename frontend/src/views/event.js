...
export default (event, userId, specificGuests) => {
  ...
  return `
    ...
    : ele.guest_status === 'canceled'
      ...
      : '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="cursor-pointer size-6 lucide lucide-circle-check"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>')).join('')}
          </div>
          ` : ''}
