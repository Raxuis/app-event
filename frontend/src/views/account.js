...
<div class="h-full flex flex-col items-center justify-center pt-6 sm:pt-20 px-4">
          <div class="border border-gray-300 rounded-md p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form class="space-y-6 edit-form">
              ...
              <div>
                <label class="text-sm mb-2 block">New Password<span class="text-red-500 pl-3 password-span"></span></label>
                <div class="relative flex items-center">
                  <input name="new-password" type="password" required class="w-full text-sm border border-gray-300 px-4 py-3 rounded-md outline-[#333]" placeholder="Enter password" id="new-password" />
              ...
              <div class="relative flex items-center">
                <input name="new-password-confirmation" type="password" required class="w-full text-sm border border-gray-300 px-4 py-3 rounded-md outline-[#333]" placeholder="Enter confirmation password" id="new-password-confirmation"/>
