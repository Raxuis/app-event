...
const Model = class {
  ...
  async render() {
    ...
    <div class="flex-shrink-0">
          <button type="button" onclick="window.location.href='/event-creation'" class="flex items-center justify-center px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto hover:bg-gray-100">
