export default (resources) => {
  ...
  return (`
      <td class="pt-4 text-start">
        ...
        <span class="text-center align-baseline inline-flex py-1.5 px-6 rounded-lg items-center font-semibold text-[.95rem] leading-none bg-blue-chill-100 text-blue-chill-600 cursor-default">
