export default () => (`
<div class="add-event select-none group cursor-pointer text-gray-700 grid grid-flow-col auto-cols-max justify-center bg-clip-border border-2 border-violet-300 border-dashed rounded-lg bg-slate-400 bg-opacity-15 hover:bg-violet-300 hover:bg-opacity-30 duration-300 p-8">
