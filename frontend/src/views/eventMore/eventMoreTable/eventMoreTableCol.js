...
<tr class="border-b border-dashed last:border-b-0">
  ...
  <span class="text-center align-baseline inline-flex px-2 py-1 mr-auto items-center font-semibold text-base/none text-slate-500 rounded-lg duration-300 hover:text-slate-800">${guestEmail}</span>
  </td>
