  ...
  <div class="max-w-6xl mx-auto px-4">
    <div class="flex justify-between">
      <div class="flex space-x-4">
        <div>
          <a href="/" class="flex items-center py-5 px-2 space-x-2" title="homepage">
        ...
        <div class="hidden md:flex items-center space-x-1">
          <a href="/event-creation" class="py-5 px-3 text-gray-700 hover:text-gray-900" title="event creation">Create an Event</a>
          <a href="/my-events" class="py-5 px-3 text-gray-700 hover:text-gray-900" title="my events">My Events</a>
        </div>
        ` : ''}
      </div>
      ...
      <div class="hidden md:flex items-center space-x-1">
      ${userId === null ? `
        <a href="/login" class="py-5 px-3" title="login">Login</a>
        <a href="/register" class="bg-electric-violet-600 text-white items-center text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 shadow hover:bg-electric-violet-500 h-9 px-4 py-2 hidden max-w-52 overflow-hidden whitespace-pre md:flex group relative w-full justify-center gap-2 rounded-md transition-all duration-300 ease-out hover:ring-2 hover:ring-electric-violet-500 hover:ring-offset-1" title="register">Register</a>
        ` : `
        <a href="/logout" class="py-5 px-3 text-gray-700 hover:text-gray-900 mr-2" title="log out">Log Out</a>
