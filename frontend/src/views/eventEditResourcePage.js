import editResourceSvg from '../assets/edit-resource.svg';
...
<div class="text-[#333] flex max-w-sm:flex-col items-center justify-center">
      <div class="sm:min-h-screen max-sm:mt-10 flex flex-col items-center justify-center px-4">
        <div class="grid md:grid-cols-2 items-center gap-4 max-w-7xl w-full">
          ...
          <form class="space-y-6 form-edit-resource">
          <div class="mb-10">
          <h3 class="text-3xl font-extrabold">Editing resource n°$</h3>
            <p class="text-sm mt-4">Efficiently edit your resources with our easy-to-use edition form. Whether you need to change the type, or the price, we simplify the process.</p>
          </div>
